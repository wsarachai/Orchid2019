...
class Orchids52Resnet50(object):
    def __init__(self, inputs, outputs, optimizer, loss_fn, resnet, predict_layers, training, step):
        super(Orchids52Resnet50, self).__init__()
    ...
    def load_from_v1(self, latest_checkpoint, target_model="resnetv2_01_50_224_", model_name="ResnetV2", **kwargs):
    ...
    def set_resnet_training_status(self, trainable, fine_tune_at=100):
        if self.resnet:
            if trainable:
                ...
                if fine_tune_at:
                    ...
                    for layer in self.resnet.layers[:fine_tune_at]:
