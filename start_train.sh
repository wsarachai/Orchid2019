...
readonly connections=(       
    '1|64|50|0.01|False'
    '1|64|100|0.0005|True'
    '2|4|5|0.001|False'
    '3|4|5|0.001|False'
    '4|4|15|0.001|False'
    '5|4|200|0.00008|True'
)
...
function training_model(){
    ...
    do
        IFS=$'|' read -r train_step batch_size total_epochs learning_rate fine_tune <<< "$fields"
        python train.py "--train_step=${train_step}" "--fine_tune=${fine_tune}" "--batch_size=${batch_size}" "--dataset_format=files" "--dataset=orchids52_data" "--dataset_version=v1" "--model=mobilenet_v2_140_stn_v15" "--learning_rate=${learning_rate}" "--total_epochs=${total_epochs}" "--save_model=True" "--bash=False" "--learning_rate_decay=exponential" "--trained_dir=${trained_dir}"
