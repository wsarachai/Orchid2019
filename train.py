...
def main(unused_argv):
    ...
    train_ds = data_utils.load_dataset(flags=FLAGS, workspace_path=workspace_path, split=split, one_hot=True)

    create_model = mapping.nets_mapping[FLAGS.model]
