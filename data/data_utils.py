...
FLOWERS17_V1_FILE = PATTERNS.format(FLOWERS17, DATA_FORMAT_FILES, DATASET_VERSION_V2)
FLOWERS102_V1_FILE = PATTERNS.format(FLOWERS102, DATA_FORMAT_FILES, DATASET_VERSION_V2)
FLOWERS17_V1_TFRECORD = PATTERNS.format(FLOWERS17, DATA_FORMAT_TF_RECORDS, DATASET_VERSION_V2)
FLOWERS102_V1_TFRECORD = PATTERNS.format(FLOWERS102, DATA_FORMAT_TF_RECORDS, DATASET_VERSION_V2)
FLOWERS17_V1_H5 = PATTERNS.format(FLOWERS17, DATA_FORMAT_H5, DATASET_VERSION_V2)
...
def load_dataset(flags, workspace_path, split="train"):
    ...
    return dataset_mapping[dataset](split=split, batch_size=flags.batch_size, root_path=data_dir)
