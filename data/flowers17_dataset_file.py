...
def load_dataset_v1(split, batch_size, root_path, **kwargs):
    return OrchidsDataset()._load_dataset(
        ...
        num_of_class=flowers17_dataset.NUM_OF_CLASSES,
...
def load_dataset_v2(split, batch_size, root_path, **kwargs):
    return OrchidsDataset()._load_dataset(
        ...
        batch_size=batch_size,
        num_of_class=flowers17_dataset.NUM_OF_CLASSES,
        train_size=flowers17_dataset.TRAIN_SIZE_V2,
        test_size=flowers17_dataset.TEST_SIZE_V2,
        validate_size=flowers17_dataset.VALIDATE_SIZE_V2,
        **kwargs
    )
