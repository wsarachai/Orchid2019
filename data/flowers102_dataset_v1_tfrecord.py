...
def _load_dataset(
    ...
    preprocess_image = wrapped_partial(flowers102_dataset.preprocess_image, image_size=mobilenet_v2.IMG_SIZE_224)
    ...
    setattr(decode_dataset, "num_of_classes", flowers102_dataset.NUM_OF_CLASSES)
...
load_dataset_v1 = wrapped_partial(
    _load_dataset,
    train_size=flowers102_dataset.TRAIN_SIZE_V1,
    test_size=flowers102_dataset.TEST_SIZE_V1,
    data_dir="tf-records/v1",
)

load_dataset_v1.num_of_classes = flowers102_dataset.NUM_OF_CLASSES
load_dataset_v1.train_size = flowers102_dataset.TRAIN_SIZE_V1
load_dataset_v1.test_size = flowers102_dataset.TEST_SIZE_V1
