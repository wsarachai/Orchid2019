...
get_label = wrapped_partial(
    _get_label,
    depth=data.constants.NUM_OF_CLASSES)

load_dataset_v1 = wrapped_partial(
    _load_dataset,
    train_size=data.constants.TRAIN_SIZE_V1,
    test_size=data.constants.TEST_SIZE_V1,
    data_dir='tf-records/v1')

load_dataset_v1.num_of_classes = data.constants.NUM_OF_CLASSES
load_dataset_v1.train_size = data.constants.TRAIN_SIZE_V1
load_dataset_v1.test_size = data.constants.TEST_SIZE_V1
