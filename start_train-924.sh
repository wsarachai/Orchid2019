...
readonly connections=(
    ...
    '1|32|150|60,100|0.001,0.0005,0.0001|0.6|False|0|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|108|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|99|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|90|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|81|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|72|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|64|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|55|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|46|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|37|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|28|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|19|True'
    '1|8|400|75|0.00001,0.000001|0.6|True|10|True'
)
...
function training_model(){
    ...
    do
        ...
        python train.py "--train_step=${train_step}" "--batch_size=${batch_size}" "--dataset_format=tf-records" "--dataset=orchids52_data" "--dataset_version=v1" "--model=mobilenet_v2_140_stn_v15" "--total_epochs=${total_epochs}" "--learning_rate_decay=${learning_rate_decay}" "--learning_rate_boundaries=${learning_rate_boundaries}" "--learning_rate=${learning_rate}" "--fine_tune=${fine_tune}" "--fine_tune_at=${fine_tune_at}" "--save_best_only=${save_best_only}" "--dropout=${dropout}" "--save_model=True" "--bash=False" "--trained_dir=${trained_dir}"
